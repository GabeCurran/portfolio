...
export default function TypingIntro() {
  ...
  return (
    <section id="intro" ref={containerRef} className="flex flex-col items-center text-center gap-4">
      ...
      <h2 className="text-lg sm:text-xl font-bold">B.S. in Computer Science from <a href="https://www.drexel.edu/" target="_blank" rel="noreferrer" className="college drexel">Drexel University</a></h2>
      <h2 className="text-lg sm:text-xl font-bold">A.A.S in Software Engineering from <a href="https://stevenscollege.edu/" target="_blank" rel="noreferrer" className="college tsct">TSCT</a></h2>
